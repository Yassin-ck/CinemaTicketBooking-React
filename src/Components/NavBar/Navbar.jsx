...
const {modalOpen,setModalOpen,user,getView } = useContext(AuthContext)
  ...
  return (
    ...
    <AiOutlineSearch  style={{ margin: 'auto', fontSize: '23px',color:'grey',position:'absolute',top:'6px',left:'12px'}} />
        ...
        {modalOpen ?
          ...
          :<div style={{display:'flex',alignItems:'center',width:'7rem',justifyContent:'space-between'}}><h2><Sidebar  /></h2> {user.username? <h5 >{user.username}</h5>:<h5> Guest</h5>}
          </div>
